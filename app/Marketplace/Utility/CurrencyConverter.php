...
class CurrencyConverter
{
    ...
    public static function convert($usdValue, $localValue = 'usd') {
        ...
        return number_format($converter->convert($usdValue, $localValue), 2);
    }
    ...
    public static function convertToUsd($localAmount) {
        ...
        $converter = resolve('MultiCurrencyModule\Converter');
        return number_format($converter->convertFromLocal($localAmount, CurrencyConverter::getLocalCurrency()), 2);
    }
