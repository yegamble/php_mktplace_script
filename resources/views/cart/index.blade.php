                    ...
                    <div class="col-md-1 d-flex align-items-center text-center">
                        ...
                        <select name="coin" id="coin" class="form-control form-control-sm">
                            @foreach($item -> offer -> product -> getCoins() as $coin)
                                <option value="{{ $coin }}" {{ $coin == $item -> coin_name ? 'selected' : ''}} >{{ strtoupper($coin) }}</option>
                            @endforeach
                        </select>
                        @elseif(count($item -> offer -> product -> getCoins()) == 1)
                            <input type="hidden" name="coin" value="{{ $item -> offer -> product -> getCoins()[0] }}">
                            <input type="text" value="{{ strtoupper($item -> offer -> product -> getCoins()[0]) }}" class="form-control form-control-sm disabled" disabled>
                        @endif
                    </div>
                    <div class="col-md-1 d-flex align-items-center">
