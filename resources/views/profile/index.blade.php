    ...
    <div class="row">
        <div class="col-md-12">
            <form action="{{ route('profile.vendor.address') }}" method="POST">
                ...
                <div class="form-row">
                    <div class="col-md-6">
                        <input type="text" class="form-control form-control-lg d-flex" name="address" id="address" placeholder="Place your new address here">
                    </div>
                    <div class="col-md-2">
                        <select name="coin" id="coin" class="form-control form-control-lg d-flex">
                            ...
                            @foreach(config('coins.coin_list') as $supportedCoin => $instance)
                                <option value="{{ $supportedCoin }}">{{ strtoupper($supportedCoin) }}</option>
                            @endforeach
                        </select>
                    </div>
                    <div class="col-md-4">
