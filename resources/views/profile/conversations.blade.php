                        ...
                        <a href="{{ route('profile.messages', $conversationItem) }}"
                           class="list-group-item d-flex justify-content-between list-group-item-action">
                            ...
                            <span class="d-flex">
                                ...
                                <span class="badge badge-light d-flex ml-1 align-items-center badge-pill">Updated {{ \Carbon\Carbon::parse($conversationItem -> messages() -> orderByDesc('created_at') -> first() -> created_at) -> diffForHumans() }}</span>
                            </span>
                        </a>
                    @endforeach
                </div>
